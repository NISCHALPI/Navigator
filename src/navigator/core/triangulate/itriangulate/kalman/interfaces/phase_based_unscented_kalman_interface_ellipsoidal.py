...
__all__ = ["EllipsoidalStateUnscentedKalmanInterface"]


class EllipsoidalStateUnscentedKalmanInterface(IKalman):
    ...
    def process_state(self, state: np.ndarray) -> Series:
        ...
        """
        x, y, z = ellipsoidal_to_geocentric(lat=state[0], lon=state[2], alt=state[4])
